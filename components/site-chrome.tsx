...
export function SiteHeader() {
  ...
  return <header className="site-header">
    <a className="brand" href="/" aria-label="Finding Hope Africa home"><img className="brand-logo" src="/finding-hope-africa-logo.png" alt="Finding Hope Africa" /></a>
